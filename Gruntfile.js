	...
	grunt.initConfig({
		...
		concat: {
			css: {
				...
				dest: '_gh_pages/dist/css/downonthefarmgala.css'
			},
			js: {
				options: {
					separator: ';',
				...
				dest: '_gh_pages/dist/js/downonthefarmgala.js'
			}
		},
		cssmin: {
			css: {
				src: '_gh_pages/dist/css/downonthefarmgala.css',
				dest: '_gh_pages/dist/css/min/downonthefarmgala.min.css'
			}
		},
		uglify: {
			js: {
				src: '_gh_pages/dist/js/downonthefarmgala.js',
				dest: '_gh_pages/dist/js/min/downonthefarmgala.min.js'
			}
		},
		watch: {
			css: {
